              ...
              {visibleAddons.map((addon) => {
                ...
                return (
                  <div
                    ...
                    className={`
                      group flex items-start justify-between gap-3 sm:gap-4 p-4 sm:p-6
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <div className={`
                          w-4 h-4 sm:w-5 sm:h-5 rounded-md border flex items-center justify-center
                    ...
                    {!isIncluded && (
                      <span className={`
                        text-xs sm:text-sm font-medium transition-colors duration-200 flex-shrink-0 pt-1
